...
We recommend installation of GrooD via pip:
...
grood --sc test_data/Hao_reference_test.h5ad \
    ...
    --threads 8
```
This will train GrooD on canonical pseudobulks comprising 7 cell types and then run inference and prediction evaluation on the independent bulk data.
